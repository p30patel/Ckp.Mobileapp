...
app.controller('orderDetailController', [
                   '$rootScope', '$scope', 'authService', 'orderDataService', '$sce', 'translateService', 'feedbackDataService', 'notificationDataService', '$timeout', 'localStorageService', 'ngAuthSettings',
function ($rootScope, $scope, authService, orderDataService, $sce, translateService, feedbackDataService, notificationDataService, $timeout, localStorageService, ngAuthSettings) {
    ...
    if (!$rootScope.hasBackButtonDetail) {
        $scope.order = {};
    ...
    //order line detail
    $scope.showOrderLineDetail = function (orderLineId, quantity) {
        $rootScope.hasBackButtonDetail = true;
        kendo.mobile.application.navigate("src/app/order/orderLineDetail.html?orderLineId=" + orderLineId + "&retailerId=" + $scope.retailerId + "&quantity=" + quantity);
    };
