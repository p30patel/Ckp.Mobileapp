...
app.controller('orderDetailController', [
                   ...
                   function ($scope, authService, orderDataService, $sce, translateService, feedbackDataService, $timeout) {
                       ...
                       $scope.form.faildInquiry.resoruceName = "Faild to Send Inquiry";
